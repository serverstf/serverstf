# Django settings for serverstf project.
...
DATABASES = {
	'default': {
		...
		'NAME': 'serverstf.db',					  # Or path to database file if using sqlite3.
...
ROOT_URLCONF = 'serverstf.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'serverstf.wsgi.application'
...
INSTALLED_APPS = (
	...
	# Uncomment if you installed south
	# "south",
)
